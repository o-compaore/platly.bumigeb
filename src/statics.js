...
const RESULTAT_DATA_REJET_URL = `${BASE_URL}/api/services/rejet_demande_jaugeage/`
const DELETE_DEMANDE_DATA_URL = `${BASE_URL}/api/services/delete_demande_jaugeage/`
...
export default { LOGIN_URL, BASE_URL,DEMANDE_DATA_URL, DEMANDE_DATA_ADD_URL, 
    ...
    PROGRAMME_VISITE_DATA_URL, PROGRAMME_VISITE_DATA_ADD_URL,
     VEHICLES_DATA_URL, VEHICLES_PHOTO_URL,VEHICLES_DELETE_URL,
      VEHICLES_METADA_URL, QRCODE_IMAGE_URL, RESULTAT_DATA_REJET_URL,
      DELETE_DEMANDE_DATA_URL };